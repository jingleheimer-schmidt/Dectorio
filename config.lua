...
DECT.CONFIG.SIGNALS = {
	...
	{type = "tool", name = "logistic-science-pack", color = {r = 0.18, g = 0.60, b = 0.11, a = 1.00}},
	{type = "tool", name = "chemical-science-pack", color = {r = 0.15, g = 0.65, b = 0.75, a = 1.00}},
	{type = "tool", name = "military-science-pack", color = {r = 0.23, g = 0.27, b = 0.31, a = 1.00}},
	{type = "tool", name = "production-science-pack", color = {r = 0.58, g = 0.11, b = 0.76, a = 1.00}},
	{type = "tool", name = "utility-science-pack", color = {r = 0.81, g = 0.69, b = 0.08, a = 1.00}},
	{type = "tool", name = "space-science-pack", color = {r = 0.96, g = 0.96, b = 0.96, a = 1.00}},
